...
public class EmployeeDoublyLinkedList {
    ...
    public boolean addBefore(Employee newEmployee, Employee existingEmployee) {
        ...
        // add your code here
    		EmployeeNode nodeNew = new EmployeeNode(newEmployee);
    		...
    		while (current != null && !(current.getEmployee()).equals(existingEmployee)) {
    			 current = current.getNext();
            	   ...
            	   nodeNew.setPrevious(previous);
            	   nodeNew.setNext(current);
            	   current.setPrevious(nodeNew);
            	   if (current == head) {
            		  head = nodeNew;
            	   }
            	   else {
            		   previous.setNext(nodeNew);
            	   }
